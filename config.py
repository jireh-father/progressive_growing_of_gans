...
# train = EasyDict(func='util_scripts.generate_fake_images', run_id=1, num_pngs=300);
# num_gpus = 1;
...
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=1, grid_size=[3, 3], duration_sec=45.0,
                 smoothing_sec=1.0);
num_gpus = 1;
